...
public class oopsq9 {
    public static void main(String[] args) {
        Student student1 = new Student("1001", "sudeshna");
        Student student2 = new Student("1002", "mist");

        Course course1 = new Course("dsa", "data structure", 80);
        Course course2 = new Course("maths", "Calculus I", 87);
