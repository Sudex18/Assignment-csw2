...
class SavingsAccount extends Account {
    ...
    public void withdraw(double amount) {
        if (amount <= getBalance()) {
            ...
            System.out.println("Insufficient balance,im sad");
        }
    }
}
...
public class oopsq7 {
    public static void main(String[] args) {
        ...
        SavingsAccount savingsAccount = new SavingsAccount(16587675, 7000, 8.0);
        CurrentAccount currentAccount = new CurrentAccount(66676587, 8000, 4300);

        // Testing deposit and withdrawal operations
        savingsAccount.deposit(500);
        savingsAccount.withdraw(450);
        currentAccount.deposit(1800);
        currentAccount.withdraw(2800);
