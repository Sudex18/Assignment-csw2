...
public class oopsq6 {
    public static void main(String[] args) {
        ...
        Book book = new Book("Java", "jawarhal nehru", 500);
        Magazine magazine = new Magazine("king the land", " Authors king", "March 2023");
        DVD dvd = new DVD("twisted college life", "sudeshna", 147);
