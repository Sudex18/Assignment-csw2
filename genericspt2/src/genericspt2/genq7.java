...
public class genq7 {
    public static void main(String[] args) {
        ...
        addressMap.put("Alice", new Address("123", "XYZ Street", "tokyo"));
        addressMap.put("Bob", new Address("456", "ABC ", "bhubaneswar"));
        addressMap.put("Charlie", new Address("789", "Avenue", "baripada"));
