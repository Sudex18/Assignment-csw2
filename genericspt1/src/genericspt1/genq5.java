...
class Student2 {
    ...
    public static void main(String[] args) {
        ...
        studentArray[0] = new Student2("Aliiii", "S123", 85);
        studentArray[1] = new Student2("Bobby", "S456", 92);
        studentArray[2] = new Student2("Carolli", "S789", 78);
        studentArray[3] = new Student2("Daved", "S234", 88);
        studentArray[4] = new Student2("Eveyy", "S567", 95);
