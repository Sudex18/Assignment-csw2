...
public class dsaq3q4 {
    public static void main(String[] args) {
        BST bst = new BST();

        bst.insert(new Country("UN", 320000));
        bst.insert(new Country("India", 1380000000));
        bst.insert(new Country("China", 1453000));
        bst.insert(new Country("Russia", 16565000));
        bst.insert(new Country("malaysia", 25500000));
